...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="index.html">Anasayfa</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Ürünler</strong></div>
      </div>
    </div>
  </div>
          ...
          <div class="row">
            <div class="col-md-12 mb-5">
              ...
              <div class="d-flex">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuReference" data-toggle="dropdown">Önerilen</button>
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                    <a class="dropdown-item" href="#">Alakalı</a>
                    <a class="dropdown-item" href="#">A'dan Z'ye</a>
                    <a class="dropdown-item" href="#">Z'den A'ya </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">Düşük fiyattan yükseğe</a>
                    <a class="dropdown-item" href="#">Yüksek fiyattan düşüğe</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row mb-5">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                ...
                <div class="block-4-text p-4">
                  <h3><a href="shop-single.html">Tişört</a></h3>
                  <p class="mb-0"> </p>
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                ...
                <div class="block-4-text p-4">
                  <h3><a href="shop-single.html">Ayakkabı</a></h3>
                  <p class="mb-0"></p>
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                ...
                <div class="block-4-text p-4">
                  <h3><a href="shop-single.html">Polo Yaka Tişört</a></h3>
                  <p class="mb-0"></p>
                  <p class="text-primary font-weight-bold">450₺</p>
                </div>
              </div>
